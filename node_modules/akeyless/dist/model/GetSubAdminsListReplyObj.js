...
var _AllowedAccess = _interopRequireDefault(require("./AllowedAccess"));
 ...
 * @version 2.20.3
 */
var GetSubAdminsListReplyObj = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetSubAdminsListReplyObj</code>.
   * @alias module:model/GetSubAdminsListReplyObj
   */
  function GetSubAdminsListReplyObj() {
    _classCallCheck(this, GetSubAdminsListReplyObj);
  ...
  _createClass(GetSubAdminsListReplyObj, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('allowed_access')) {
          obj['allowed_access'] = _ApiClient["default"].convertToType(data['allowed_access'], {
            'String': _AllowedAccess["default"]
          });
        }
      }
...
var _default = GetSubAdminsListReplyObj;
