 ...
 * @version 2.20.3
 */
var UpdateRabbitMQTargetDetails = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UpdateRabbitMQTargetDetails</code>.
   * @alias module:model/UpdateRabbitMQTargetDetails
   * @param name {String} Target name
   */
  function UpdateRabbitMQTargetDetails(name) {
    _classCallCheck(this, UpdateRabbitMQTargetDetails);
  ...
  _createClass(UpdateRabbitMQTargetDetails, null, [{
    key: "initialize",
...
var _default = UpdateRabbitMQTargetDetails;
