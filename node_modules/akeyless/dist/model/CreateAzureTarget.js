 ...
 * @version 2.20.3
 */
var CreateAzureTarget = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreateAzureTarget</code>.
   * @alias module:model/CreateAzureTarget
   * @param name {String} Target name
   */
  function CreateAzureTarget(name) {
    _classCallCheck(this, CreateAzureTarget);
  ...
  _createClass(CreateAzureTarget, null, [{
    key: "initialize",
...
var _default = CreateAzureTarget;
