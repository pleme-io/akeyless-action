 ...
 * @version 2.20.3
 */
var UpdateAuthMethod = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UpdateAuthMethod</code>.
   * @alias module:model/UpdateAuthMethod
   * @param name {String} Auth Method name
   */
  function UpdateAuthMethod(name) {
    _classCallCheck(this, UpdateAuthMethod);
  ...
  _createClass(UpdateAuthMethod, null, [{
    key: "initialize",
