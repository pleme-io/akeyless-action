 ...
 * @version 2.20.3
 */
var GetTargetDetails = /*#__PURE__*/function () {
  /**
  ...
  function GetTargetDetails(name) {
    _classCallCheck(this, GetTargetDetails);
  ...
  _createClass(GetTargetDetails, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('show-versions')) {
          obj['show-versions'] = _ApiClient["default"].convertToType(data['show-versions'], 'Boolean');
        }

        if (data.hasOwnProperty('target-version')) {
          obj['target-version'] = _ApiClient["default"].convertToType(data['target-version'], 'Number');
        }
