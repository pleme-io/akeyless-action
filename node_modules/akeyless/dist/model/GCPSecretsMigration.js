...
var _GCPPayload = _interopRequireDefault(require("./GCPPayload"));
 ...
 * @version 2.20.3
 */
var GCPSecretsMigration = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GCPSecretsMigration</code>.
   * @alias module:model/GCPSecretsMigration
   */
  function GCPSecretsMigration() {
    _classCallCheck(this, GCPSecretsMigration);
  ...
  _createClass(GCPSecretsMigration, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _GCPPayload["default"].constructFromObject(data['payload']);
        }
      }
...
var _default = GCPSecretsMigration;
