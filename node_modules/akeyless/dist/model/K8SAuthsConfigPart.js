...
var _K8SAuth = _interopRequireDefault(require("./K8SAuth"));
 ...
 * @version 2.20.3
 */
var K8SAuthsConfigPart = /*#__PURE__*/function () {
  /**
  ...
  _createClass(K8SAuthsConfigPart, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('k8s_auths')) {
          obj['k8s_auths'] = _ApiClient["default"].convertToType(data['k8s_auths'], [_K8SAuth["default"]]);
        }
      }
...
var _default = K8SAuthsConfigPart;
