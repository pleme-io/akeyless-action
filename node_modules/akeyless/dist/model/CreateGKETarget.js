 ...
 * @version 2.20.3
 */
var CreateGKETarget = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreateGKETarget</code>.
   * @alias module:model/CreateGKETarget
   * @param name {String} Target name
   */
  function CreateGKETarget(name) {
    _classCallCheck(this, CreateGKETarget);
  ...
  _createClass(CreateGKETarget, null, [{
    key: "initialize",
