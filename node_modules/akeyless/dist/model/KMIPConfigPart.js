...
var _KMIPClient = _interopRequireDefault(require("./KMIPClient"));

var _KMIPServer = _interopRequireDefault(require("./KMIPServer"));
 ...
 * @version 2.20.3
 */
var KMIPConfigPart = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>KMIPConfigPart</code>.
   * @alias module:model/KMIPConfigPart
   */
  function KMIPConfigPart() {
    _classCallCheck(this, KMIPConfigPart);
  ...
  _createClass(KMIPConfigPart, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('clients')) {
          obj['clients'] = _ApiClient["default"].convertToType(data['clients'], {
            'String': _KMIPClient["default"]
          });
        }

        if (data.hasOwnProperty('key_enc')) {
          obj['key_enc'] = _ApiClient["default"].convertToType(data['key_enc'], ['Number']);
        }

        if (data.hasOwnProperty('server')) {
          obj['server'] = _KMIPServer["default"].constructFromObject(data['server']);
        }

        if (data.hasOwnProperty('server_enc')) {
          obj['server_enc'] = _ApiClient["default"].convertToType(data['server_enc'], ['Number']);
        }
      }
