...
var _GwClusterIdentity = _interopRequireDefault(require("./GwClusterIdentity"));
 ...
 * @version 2.20.3
 */
var GatewaysListResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function GatewaysListResponse() {
    _classCallCheck(this, GatewaysListResponse);
  ...
  _createClass(GatewaysListResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('clusters')) {
          obj['clusters'] = _ApiClient["default"].convertToType(data['clusters'], [_GwClusterIdentity["default"]]);
        }
      }
...
var _default = GatewaysListResponse;
