 ...
 * @version 2.20.3
 */
var UpdateAzureTarget = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UpdateAzureTarget</code>.
   * @alias module:model/UpdateAzureTarget
   * @param name {String} Target name
   */
  function UpdateAzureTarget(name) {
    _classCallCheck(this, UpdateAzureTarget);
  ...
  _createClass(UpdateAzureTarget, null, [{
    key: "initialize",
...
var _default = UpdateAzureTarget;
