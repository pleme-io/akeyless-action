 ...
 * @version 2.20.3
 */
var CreateWebTarget = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreateWebTarget</code>.
   * @alias module:model/CreateWebTarget
   * @param name {String} Target name
   */
  function CreateWebTarget(name) {
    _classCallCheck(this, CreateWebTarget);
  ...
  _createClass(CreateWebTarget, null, [{
    key: "initialize",
