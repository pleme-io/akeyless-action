 ...
 * @version 2.20.3
 */
var CreateAWSTarget = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreateAWSTarget</code>.
   * @alias module:model/CreateAWSTarget
   * @param name {String} Target name
   */
  function CreateAWSTarget(name) {
    _classCallCheck(this, CreateAWSTarget);
  ...
  _createClass(CreateAWSTarget, null, [{
    key: "initialize",
