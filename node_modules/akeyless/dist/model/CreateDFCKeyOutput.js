 ...
 * @version 2.20.3
 */
var CreateDFCKeyOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreateDFCKeyOutput</code>.
   * @alias module:model/CreateDFCKeyOutput
   */
  function CreateDFCKeyOutput() {
    _classCallCheck(this, CreateDFCKeyOutput);
  ...
  _createClass(CreateDFCKeyOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('fragment_results')) {
          obj['fragment_results'] = _ApiClient["default"].convertToType(data['fragment_results'], ['Number']);
        }
      }
...
var _default = CreateDFCKeyOutput;
