 ...
 * @version 2.20.3
 */
var CreateAuthMethod = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreateAuthMethod</code>.
   * @alias module:model/CreateAuthMethod
   * @param name {String} Auth Method name
   */
  function CreateAuthMethod(name) {
    _classCallCheck(this, CreateAuthMethod);
  ...
  _createClass(CreateAuthMethod, null, [{
    key: "initialize",
