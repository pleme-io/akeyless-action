 ...
 * @version 2.20.3
 */
var UpdateGKETarget = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UpdateGKETarget</code>.
   * @alias module:model/UpdateGKETarget
   * @param name {String} Target name
   */
  function UpdateGKETarget(name) {
    _classCallCheck(this, UpdateGKETarget);
  ...
  _createClass(UpdateGKETarget, null, [{
    key: "initialize",
