...
var _SystemAccessCredentialsReplyObj = _interopRequireDefault(require("./SystemAccessCredentialsReplyObj"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('creds')) {
          obj['creds'] = _SystemAccessCredentialsReplyObj["default"].constructFromObject(data['creds']);
        }
