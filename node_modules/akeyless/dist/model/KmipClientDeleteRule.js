 ...
 * @version 2.20.3
 */
var KmipClientDeleteRule = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>KmipClientDeleteRule</code>.
   * @alias module:model/KmipClientDeleteRule
   * @param path {String} Access path
   */
  function KmipClientDeleteRule(path) {
    _classCallCheck(this, KmipClientDeleteRule);
  ...
  _createClass(KmipClientDeleteRule, null, [{
    key: "initialize",
...
var _default = KmipClientDeleteRule;
