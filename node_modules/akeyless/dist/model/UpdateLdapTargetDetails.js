 ...
 * @version 2.20.3
 */
var UpdateLdapTargetDetails = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UpdateLdapTargetDetails</code>.
   * @alias module:model/UpdateLdapTargetDetails
   * @param name {String} Target name
   */
  function UpdateLdapTargetDetails(name) {
    _classCallCheck(this, UpdateLdapTargetDetails);
  ...
  _createClass(UpdateLdapTargetDetails, null, [{
    key: "initialize",
...
var _default = UpdateLdapTargetDetails;
