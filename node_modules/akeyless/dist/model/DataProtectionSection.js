 ...
 * @version 2.20.3
 */
var DataProtectionSection = /*#__PURE__*/function () {
  /**
  ...
  function DataProtectionSection() {
    _classCallCheck(this, DataProtectionSection);
  ...
  _createClass(DataProtectionSection, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('enable_classic_key_protection')) {
          obj['enable_classic_key_protection'] = _ApiClient["default"].convertToType(data['enable_classic_key_protection'], 'Boolean');
        }
      }
...
var _default = DataProtectionSection;
