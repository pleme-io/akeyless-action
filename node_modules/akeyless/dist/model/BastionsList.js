...
var _BastionListEntry = _interopRequireDefault(require("./BastionListEntry"));
 ...
 * @version 2.20.3
 */
var BastionsList = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>BastionsList</code>.
   * @alias module:model/BastionsList
   */
  function BastionsList() {
    _classCallCheck(this, BastionsList);
  ...
  _createClass(BastionsList, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('clusters')) {
          obj['clusters'] = _ApiClient["default"].convertToType(data['clusters'], [_BastionListEntry["default"]]);
        }
      }
