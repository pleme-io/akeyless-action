 ...
 * @version 2.20.3
 */
var GetRotatedSecretValue = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetRotatedSecretValue</code>.
   * @alias module:model/GetRotatedSecretValue
   * @param names {String} Secret name
   */
  function GetRotatedSecretValue(names) {
    _classCallCheck(this, GetRotatedSecretValue);
  ...
  _createClass(GetRotatedSecretValue, null, [{
    key: "initialize",
...
var _default = GetRotatedSecretValue;
