 ...
 * @version 2.20.3
 */
var UpdateAWSTarget = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UpdateAWSTarget</code>.
   * @alias module:model/UpdateAWSTarget
   * @param name {String} Target name
   */
  function UpdateAWSTarget(name) {
    _classCallCheck(this, UpdateAWSTarget);
  ...
  _createClass(UpdateAWSTarget, null, [{
    key: "initialize",
