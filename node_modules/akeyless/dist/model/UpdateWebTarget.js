 ...
 * @version 2.20.3
 */
var UpdateWebTarget = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UpdateWebTarget</code>.
   * @alias module:model/UpdateWebTarget
   * @param name {String} Target name
   */
  function UpdateWebTarget(name) {
    _classCallCheck(this, UpdateWebTarget);
  ...
  _createClass(UpdateWebTarget, null, [{
    key: "initialize",
