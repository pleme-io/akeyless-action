...
var _DSProducerDetails = _interopRequireDefault(require("./DSProducerDetails"));
 ...
 * @version 2.20.3
 */
var GatewayCreateProducerCertificateAutomationOutput = /*#__PURE__*/function () {
  /**
   ...
   */
  function GatewayCreateProducerCertificateAutomationOutput() {
    _classCallCheck(this, GatewayCreateProducerCertificateAutomationOutput);
  ...
  _createClass(GatewayCreateProducerCertificateAutomationOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('producer_details')) {
          obj['producer_details'] = _DSProducerDetails["default"].constructFromObject(data['producer_details']);
        }
      }
...
var _default = GatewayCreateProducerCertificateAutomationOutput;
