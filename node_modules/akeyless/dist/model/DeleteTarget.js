 ...
 * @version 2.20.3
 */
var DeleteTarget = /*#__PURE__*/function () {
  /**
  ...
  function DeleteTarget(name) {
    _classCallCheck(this, DeleteTarget);
  ...
  _createClass(DeleteTarget, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('force-deletion')) {
          obj['force-deletion'] = _ApiClient["default"].convertToType(data['force-deletion'], 'Boolean');
        }
