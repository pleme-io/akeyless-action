 ...
 * @version 2.20.3
 */
var GetRSAPublicOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetRSAPublicOutput</code>.
   * @alias module:model/GetRSAPublicOutput
   */
  function GetRSAPublicOutput() {
    _classCallCheck(this, GetRSAPublicOutput);
  ...
  _createClass(GetRSAPublicOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('ssh')) {
          obj['ssh'] = _ApiClient["default"].convertToType(data['ssh'], 'String');
        }
      }
...
var _default = GetRSAPublicOutput;
