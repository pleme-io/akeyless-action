 ...
 * @version 2.20.3
 */
var CreateDynamicSecret = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreateDynamicSecret</code>.
   * @alias module:model/CreateDynamicSecret
   * @param name {String} Dynamic secret name
   */
  function CreateDynamicSecret(name) {
    _classCallCheck(this, CreateDynamicSecret);
  ...
  _createClass(CreateDynamicSecret, null, [{
    key: "initialize",
...
var _default = CreateDynamicSecret;
