 ...
 * @version 2.20.3
 */
var RotatorsConfigPart = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>RotatorsConfigPart</code>.
   * @alias module:model/RotatorsConfigPart
   */
  function RotatorsConfigPart() {
    _classCallCheck(this, RotatorsConfigPart);
  ...
  _createClass(RotatorsConfigPart, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('rotators')) {
          obj['rotators'] = _ApiClient["default"].convertToType(data['rotators'], [_Rotator["default"]]);
        }
      }
...
var _default = RotatorsConfigPart;
