...
var KmipCreateClient = /*#__PURE__*/function () {
  ...
  _createClass(KmipCreateClient, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('activate-keys-on-creation')) {
          obj['activate-keys-on-creation'] = _ApiClient["default"].convertToType(data['activate-keys-on-creation'], 'String');
        }
