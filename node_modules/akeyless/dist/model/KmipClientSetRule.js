 ...
 * @version 2.20.3
 */
var KmipClientSetRule = /*#__PURE__*/function () {
  /**
   ...
   */
  function KmipClientSetRule(capability, path) {
    _classCallCheck(this, KmipClientSetRule);
  ...
  _createClass(KmipClientSetRule, null, [{
    key: "initialize",
    value: function initialize(obj, capability, path) {
...
var _default = KmipClientSetRule;
