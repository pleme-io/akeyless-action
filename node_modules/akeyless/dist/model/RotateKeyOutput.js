 ...
 * @version 2.20.3
 */
var RotateKeyOutput = /*#__PURE__*/function () {
  /**
  ...
  _createClass(RotateKeyOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('classic_key_gw_url')) {
          obj['classic_key_gw_url'] = _ApiClient["default"].convertToType(data['classic_key_gw_url'], 'String');
        }
        ...
        if (data.hasOwnProperty('new_item_version')) {
          obj['new_item_version'] = _ApiClient["default"].convertToType(data['new_item_version'], 'Number');
        }
