 ...
 * @version 2.20.3
 */
var KMIPEnvironmentCreateResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>KMIPEnvironmentCreateResponse</code>.
   * @alias module:model/KMIPEnvironmentCreateResponse
   */
  function KMIPEnvironmentCreateResponse() {
    _classCallCheck(this, KMIPEnvironmentCreateResponse);
  ...
  _createClass(KMIPEnvironmentCreateResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('ca_cert')) {
          obj['ca_cert'] = _ApiClient["default"].convertToType(data['ca_cert'], ['Number']);
        }
...
var _default = KMIPEnvironmentCreateResponse;
