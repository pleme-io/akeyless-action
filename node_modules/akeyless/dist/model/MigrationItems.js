...
var MigrationItems = /*#__PURE__*/function () {
  ...
  _createClass(MigrationItems, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('failed')) {
          obj['failed'] = _ApiClient["default"].convertToType(data['failed'], 'Number');
        }

        if (data.hasOwnProperty('migrated')) {
          obj['migrated'] = _ApiClient["default"].convertToType(data['migrated'], 'Number');
        }

        if (data.hasOwnProperty('skipped')) {
          obj['skipped'] = _ApiClient["default"].convertToType(data['skipped'], 'Number');
        }
