 ...
 * @version 2.20.3
 */
var GetDynamicSecretValue = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetDynamicSecretValue</code>.
   * @alias module:model/GetDynamicSecretValue
   * @param name {String} Dynamic secret name
   */
  function GetDynamicSecretValue(name) {
    _classCallCheck(this, GetDynamicSecretValue);
  ...
  _createClass(GetDynamicSecretValue, null, [{
    key: "initialize",
...
var _default = GetDynamicSecretValue;
