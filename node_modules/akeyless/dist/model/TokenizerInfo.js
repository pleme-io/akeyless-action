...
var _VaultlessTokenizerInfo = _interopRequireDefault(require("./VaultlessTokenizerInfo"));
...
var TokenizerInfo = /*#__PURE__*/function () {
  ...
  _createClass(TokenizerInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('vaultless_tokenizer_info')) {
          obj['vaultless_tokenizer_info'] = _VaultlessTokenizerInfo["default"].constructFromObject(data['vaultless_tokenizer_info']);
        }
      }
