 ...
 * @version 2.20.3
 */
var UpdateLdapTarget = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UpdateLdapTarget</code>.
   * @alias module:model/UpdateLdapTarget
   * @param name {String} Target name
   */
  function UpdateLdapTarget(name) {
    _classCallCheck(this, UpdateLdapTarget);
  ...
  _createClass(UpdateLdapTarget, null, [{
    key: "initialize",
