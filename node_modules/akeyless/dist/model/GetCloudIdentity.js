 ...
 * @version 2.20.1
 */
var GetCloudIdentity = /*#__PURE__*/function () {
  /**
  ...
  function GetCloudIdentity() {
    _classCallCheck(this, GetCloudIdentity);
  ...
  _createClass(GetCloudIdentity, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('url_safe')) {
          obj['url_safe'] = _ApiClient["default"].convertToType(data['url_safe'], 'Boolean');
        }
      }
