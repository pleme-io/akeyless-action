 ...
 * @version 2.20.3
 */
var DefaultConfigPart = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DefaultConfigPart</code>.
   * @alias module:model/DefaultConfigPart
   */
  function DefaultConfigPart() {
    _classCallCheck(this, DefaultConfigPart);
  ...
  _createClass(DefaultConfigPart, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('oidc_access_id')) {
          obj['oidc_access_id'] = _ApiClient["default"].convertToType(data['oidc_access_id'], 'String');
        }

        if (data.hasOwnProperty('saml_access_id')) {
          obj['saml_access_id'] = _ApiClient["default"].convertToType(data['saml_access_id'], 'String');
        }
      }
...
var _default = DefaultConfigPart;
