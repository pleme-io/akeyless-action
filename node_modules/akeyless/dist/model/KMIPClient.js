...
var _PathRule = _interopRequireDefault(require("./PathRule"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('activate_keys_on_creation')) {
          obj['activate_keys_on_creation'] = _ApiClient["default"].convertToType(data['activate_keys_on_creation'], 'Boolean');
        }
        ...
        if (data.hasOwnProperty('rules')) {
          obj['rules'] = _ApiClient["default"].convertToType(data['rules'], [_PathRule["default"]]);
        }
      }
