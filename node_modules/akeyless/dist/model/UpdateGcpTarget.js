 ...
 * @version 2.20.3
 */
var UpdateGcpTarget = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UpdateGcpTarget</code>.
   * @alias module:model/UpdateGcpTarget
   * @param name {String} Target name
   */
  function UpdateGcpTarget(name) {
    _classCallCheck(this, UpdateGcpTarget);
  ...
  _createClass(UpdateGcpTarget, null, [{
    key: "initialize",
