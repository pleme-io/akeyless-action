...
var _MigrationStatus = _interopRequireDefault(require("./MigrationStatus"));
...
var LastStatusInfo = /*#__PURE__*/function () {
  ...
  _createClass(LastStatusInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('migrations_status')) {
          obj['migrations_status'] = _MigrationStatus["default"].constructFromObject(data['migrations_status']);
        }

        if (data.hasOwnProperty('producers_errors')) {
          obj['producers_errors'] = _ApiClient["default"].convertToType(data['producers_errors'], Object);
        }
      }
