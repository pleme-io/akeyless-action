 ...
 * @version 2.20.3
 */
var TargetItemVersion = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TargetItemVersion</code>.
   * @alias module:model/TargetItemVersion
   */
  function TargetItemVersion() {
    _classCallCheck(this, TargetItemVersion);
  ...
  _createClass(TargetItemVersion, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item_version_state')) {
          obj['item_version_state'] = _ApiClient["default"].convertToType(data['item_version_state'], 'String');
        }

        if (data.hasOwnProperty('latest_version')) {
          obj['latest_version'] = _ApiClient["default"].convertToType(data['latest_version'], 'Boolean');
        }
...
var _default = TargetItemVersion;
