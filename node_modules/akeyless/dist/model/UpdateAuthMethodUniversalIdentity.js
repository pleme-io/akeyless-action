 ...
 * @version 2.20.3
 */
var UpdateAuthMethodUniversalIdentity = /*#__PURE__*/function () {
  /**
   ...
   */
  function UpdateAuthMethodUniversalIdentity(name) {
    _classCallCheck(this, UpdateAuthMethodUniversalIdentity);
  ...
  _createClass(UpdateAuthMethodUniversalIdentity, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('deny-inheritance')) {
          obj['deny-inheritance'] = _ApiClient["default"].convertToType(data['deny-inheritance'], 'Boolean');
        }

        if (data.hasOwnProperty('deny-rotate')) {
          obj['deny-rotate'] = _ApiClient["default"].convertToType(data['deny-rotate'], 'Boolean');
        }
...
var _default = UpdateAuthMethodUniversalIdentity;
