 ...
 * @version 2.20.3
 */
var RotateKey = /*#__PURE__*/function () {
  /**
  ...
  function RotateKey(name) {
    _classCallCheck(this, RotateKey);
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('new-key-data')) {
          obj['new-key-data'] = _ApiClient["default"].convertToType(data['new-key-data'], 'String');
        }
