 ...
 * @version 2.20.3
 */
var DescribePermissions = /*#__PURE__*/function () {
  /**
   ...
   */
  function DescribePermissions(path, type) {
    _classCallCheck(this, DescribePermissions);
  ...
  _createClass(DescribePermissions, null, [{
    key: "initialize",
    value: function initialize(obj, path, type) {
      obj['path'] = path;
      obj['type'] = type;
    }
    /**
...
var _default = DescribePermissions;
