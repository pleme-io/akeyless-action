 ...
 * @version 2.20.3
 */
var UpdateSSHTarget = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UpdateSSHTarget</code>.
   * @alias module:model/UpdateSSHTarget
   * @param name {String} Target name
   */
  function UpdateSSHTarget(name) {
    _classCallCheck(this, UpdateSSHTarget);
  ...
  _createClass(UpdateSSHTarget, null, [{
    key: "initialize",
