 ...
 * @version 2.20.3
 */
var DeleteRoleRule = /*#__PURE__*/function () {
  /**
   ...
   */
  function DeleteRoleRule(path, roleName) {
    _classCallCheck(this, DeleteRoleRule);
  ...
  _createClass(DeleteRoleRule, null, [{
    key: "initialize",
    value: function initialize(obj, path, roleName) {
      obj['path'] = path;
