...
var DeleteItemOutput = /*#__PURE__*/function () {
  ...
  _createClass(DeleteItemOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('version_deleted')) {
          obj['version_deleted'] = _ApiClient["default"].convertToType(data['version_deleted'], 'Number');
        }
      }
