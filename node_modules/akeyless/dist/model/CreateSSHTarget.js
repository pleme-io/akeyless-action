 ...
 * @version 2.20.3
 */
var CreateSSHTarget = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreateSSHTarget</code>.
   * @alias module:model/CreateSSHTarget
   * @param name {String} Target name
   */
  function CreateSSHTarget(name) {
    _classCallCheck(this, CreateSSHTarget);
  ...
  _createClass(CreateSSHTarget, null, [{
    key: "initialize",
