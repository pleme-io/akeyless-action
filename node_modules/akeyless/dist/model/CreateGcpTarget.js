 ...
 * @version 2.20.3
 */
var CreateGcpTarget = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CreateGcpTarget</code>.
   * @alias module:model/CreateGcpTarget
   * @param name {String} Target name
   */
  function CreateGcpTarget(name) {
    _classCallCheck(this, CreateGcpTarget);
  ...
  _createClass(CreateGcpTarget, null, [{
    key: "initialize",
