    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('gcp_credentials_json')) {
          obj['gcp_credentials_json'] = _ApiClient["default"].convertToType(data['gcp_credentials_json'], 'String');
        }
      }
