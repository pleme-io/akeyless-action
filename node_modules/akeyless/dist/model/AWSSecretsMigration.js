...
var _AWSPayload = _interopRequireDefault(require("./AWSPayload"));
 ...
 * @version 2.20.3
 */
var AWSSecretsMigration = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>AWSSecretsMigration</code>.
   * @alias module:model/AWSSecretsMigration
   */
  function AWSSecretsMigration() {
    _classCallCheck(this, AWSSecretsMigration);
  ...
  _createClass(AWSSecretsMigration, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('payload')) {
          obj['payload'] = _AWSPayload["default"].constructFromObject(data['payload']);
        }
      }
...
var _default = AWSSecretsMigration;
