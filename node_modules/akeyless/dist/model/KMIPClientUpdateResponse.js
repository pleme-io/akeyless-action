 ...
 * @version 2.20.3
 */
var KMIPClientUpdateResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>KMIPClientUpdateResponse</code>.
   * @alias module:model/KMIPClientUpdateResponse
   */
  function KMIPClientUpdateResponse() {
    _classCallCheck(this, KMIPClientUpdateResponse);
  ...
  _createClass(KMIPClientUpdateResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('client')) {
          obj['client'] = _KMIPClient["default"].constructFromObject(data['client']);
        }
      }
...
var _default = KMIPClientUpdateResponse;
