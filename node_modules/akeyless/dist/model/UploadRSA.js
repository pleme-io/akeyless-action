 ...
 * @version 2.20.3
 */
var UploadRSA = /*#__PURE__*/function () {
  /**
   ...
   */
  function UploadRSA(alg, name) {
    _classCallCheck(this, UploadRSA);
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('overwrite')) {
          obj['overwrite'] = _ApiClient["default"].convertToType(data['overwrite'], 'String');
        }

        if (data.hasOwnProperty('rsa-file-data')) {
          obj['rsa-file-data'] = _ApiClient["default"].convertToType(data['rsa-file-data'], 'String');
        }
