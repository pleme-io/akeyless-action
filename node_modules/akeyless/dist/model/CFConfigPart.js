 ...
 * @version 2.20.3
 */
var CFConfigPart = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CFConfigPart</code>.
   * @alias module:model/CFConfigPart
   */
  function CFConfigPart() {
    _classCallCheck(this, CFConfigPart);
  ...
  _createClass(CFConfigPart, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('customer_fragements')) {
          obj['customer_fragements'] = _ApiClient["default"].convertToType(data['customer_fragements'], {
            'String': 'String'
          });
        }
      }
