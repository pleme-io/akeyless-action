 ...
 * @version 2.20.3
 */
var GatewayDeleteProducerOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GatewayDeleteProducerOutput</code>.
   * @alias module:model/GatewayDeleteProducerOutput
   */
  function GatewayDeleteProducerOutput() {
    _classCallCheck(this, GatewayDeleteProducerOutput);
  ...
  _createClass(GatewayDeleteProducerOutput, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('producer_name')) {
          obj['producer_name'] = _ApiClient["default"].convertToType(data['producer_name'], 'String');
        }
      }
...
var _default = GatewayDeleteProducerOutput;
