...
var _ReverseRBACClient = _interopRequireDefault(require("./ReverseRBACClient"));
 ...
 * @version 2.20.3
 */
var ReverseRBACOutput = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ReverseRBACOutput</code>.
   * @alias module:model/ReverseRBACOutput
   */
  function ReverseRBACOutput() {
    _classCallCheck(this, ReverseRBACOutput);
  ...
  _createClass(ReverseRBACOutput, null, [{
    key: "initialize",
      ...
      if (data) {
        ...
        if (data.hasOwnProperty('clients')) {
          obj['clients'] = _ApiClient["default"].convertToType(data['clients'], {
            'String': _ReverseRBACClient["default"]
          });
        }
      }
...
var _default = ReverseRBACOutput;
