 ...
 * @version 2.20.3
 */
var UpdateSSHTargetDetails = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UpdateSSHTargetDetails</code>.
   * @alias module:model/UpdateSSHTargetDetails
   * @param name {String} Target name
   */
  function UpdateSSHTargetDetails(name) {
    _classCallCheck(this, UpdateSSHTargetDetails);
  ...
  _createClass(UpdateSSHTargetDetails, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('private-key')) {
          obj['private-key'] = _ApiClient["default"].convertToType(data['private-key'], 'String');
        }

        if (data.hasOwnProperty('private-key-password')) {
          obj['private-key-password'] = _ApiClient["default"].convertToType(data['private-key-password'], 'String');
        }
...
var _default = UpdateSSHTargetDetails;
